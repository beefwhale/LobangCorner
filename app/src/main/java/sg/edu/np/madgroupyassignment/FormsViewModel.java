...
public class FormsViewModel extends ViewModel {
    ...
    public void selectRecipeIngred(String string) {
        selectedRecipeIngred.setValue(string);
    }

    public LiveData<String> getSelectedRecipeIngred() {
        return selectedRecipeIngred;
    }

    //RecipeDifficulty Transfer
    private final MutableLiveData<Integer> selectedDifficulty = new MutableLiveData<Integer>();

    public void selectDifficulty(Integer integer) {
        selectedDifficulty.setValue(integer);
    }

    public LiveData<Integer> getSelectedDifficulty() {
    ...
    public void selectImg(String string) {
        selectedImg.setValue(string);
    }

    public LiveData<String> getSelectedImg() {
        return selectedImg;
    }
    ...
    public void changeFragment(Integer integer) {
        changeFragment.setValue(integer);
    }

    public LiveData<Integer> getchangeFragment() {
    ...
    public void status(Integer integer) {
        status.setValue(integer);
    }
    ...
    public void recipePost(RecipeCorner RecipeCorner) {
        recipePost.setValue(RecipeCorner);
    }

    public LiveData<RecipeCorner> getRecipePost() {
        return recipePost;
    }
}
